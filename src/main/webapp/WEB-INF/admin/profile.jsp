        ...
        <div class="header">
            <div class="top clear">
                ...
                <div class="top-right right">
                    <a href="admin/admProfile"
                       style="font-size: 14px; color: #337ab7;">${admin.adminName }(${admin.adminNumber })</a>
                    ...
                    <form action="#" method="post" class="form">
                        <div class="row item">
                            ...
                            <div class="col col-7 value">
                                <input type="text" name="username" value="${admin.adminName }" readonly>
                            </div>
                        </div>
                        <div class="row item">
                        ...
                        <div class="row item">
                            ...
                            <div class="col col-7 value">
                                <input type="text" name="telephone" value="${admin.phone }"
                        ...
                        <div class="row item">
                            ...
                            <div class="col col-7 value">
                                <input type="text" name="email" value="${admin.email }" onchange="validate_email()"/>
...
<script type="text/javascript">
    ...
    $(function () {
        //性别文本框设置性别
        //获取性别文本框
        $("input[type='radio'][name='gender'][value='${admin.gender }']").attr("checked", true);
