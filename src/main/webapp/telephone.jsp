                    ...
                    <form action="" method="post" class="form">
                        <div class="row item">
                            ...
                            <div class="col col-7 value">
                                ...
                                <div class="notice">请填写11位国内手机号码</div>
                            </div>
                        </div>
                        <div class="row item">
                            <div class="col col-2 name">验证码</div>
                            <div class="col col-7 value">
                                <div class="row">
                                    <div class="col col-5"><input type="text" name="captcha" /> </div>
                                    <div class="col col-5"><a href="javascript:;" class="btn btn-danger btn-6x">发送短信(60)</a></div>
                                </div>
                                <div class="notice">请填写短信中的验证码</div>
                            </div>
                        </div>
                        <div class="row item">
